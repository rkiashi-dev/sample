commit f672063f19d6fc45515323f4eee1e127c734c70d
Author: rkiashi.dev <rkiashi.dev@gmail.com>
Date:   Sat Aug 22 19:40:23 2015 +0900
...
+obj/
+bin/
diff --git a/cpp/.msgpack_sample.cpp.swo b/cpp/.msgpack_sample.cpp.swo
new file mode 100644
index 0000000..f295020
Binary files /dev/null and b/cpp/.msgpack_sample.cpp.swo differ
diff --git a/cpp/.msgpack_sample.cpp.swp b/cpp/.msgpack_sample.cpp.swp
new file mode 100644
index 0000000..7ee206c
Binary files /dev/null and b/cpp/.msgpack_sample.cpp.swp differ
diff --git a/cpp/msgpack.mak b/cpp/msgpack.mak
new file mode 100644
index 0000000..7968cf1
--- /dev/null
+++ b/cpp/msgpack.mak
@@ -0,0 +1,25 @@
+
...
+
+
diff --git a/cpp/msgpack_sample.cpp b/cpp/msgpack_sample.cpp
new file mode 100644
index 0000000..f1aecb9
--- /dev/null
+++ b/cpp/msgpack_sample.cpp
@@ -0,0 +1,203 @@
+
+
+#include <msgpack.hpp>
